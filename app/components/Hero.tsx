      ...
      <form onSubmit={handleSubmit} className="max-w-360 mx-auto px-4 space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <input name="incidentDate"  type="date" required placeholder="Incident Date" className="w-full px-4 py-2 rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:ring focus:ring-black focus:border-black transition duration-200"/>
            <input name="incidentTime" type="time" required placeholder="Incident Time" className="w-full px-4 py-2 rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:ring focus:ring-black focus:border-black transition duration-200"/>
