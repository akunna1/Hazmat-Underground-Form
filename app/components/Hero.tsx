      ...
      {/* Submitted By*/}
        <div className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition p-6 border border-gray-200">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <input name="SubmittedByRank" type="text" placeholder="Rank" required className="w-full px-4 py-2 rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:ring focus:ring-black focus:border-black transition duration-200"/>
